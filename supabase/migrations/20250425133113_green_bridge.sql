/*
  # Fix module enrollments schema and relationships

  1. Changes
    - Add module_enrollments table with proper relationships
    - Add RLS policies for module enrollments
    - Add columns for storing chat history and evaluation data
    - Update foreign key relationships

  2. Security
    - Enable RLS on module_enrollments table
    - Add policies for students to enroll and view their enrollments
*/
